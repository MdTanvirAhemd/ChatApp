...
public class MessageActivity extends AppCompatActivity {
    ...
    private ArrayList<com.ahmed.chatapp.Message> messages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference("messages/"+chatRoomId).push().setValue(new com.ahmed.chatapp.Message(FirebaseAuth.getInstance().getCurrentUser().getEmail(),emailOfRoommate,edtMessageInput.getText().toString()));
        ...
        FirebaseDatabase.getInstance().getReference("messages/"+ chatRoomId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    messages.add(dataSnapshot.getValue(com.ahmed.chatapp.Message.class));
                }
